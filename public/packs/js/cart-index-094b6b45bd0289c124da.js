...
document.querySelector('.cart-modal__days-value').onchange = function () {
  change_price();
};

var send_buttons = document.querySelectorAll('.cart-modal__request');
...
function change_price() {
  var price = document.querySelector('.cart-modal__product-price span').innerText;
  var regex = /\./g;
  var price_no_dot = price.replace(regex, "");
  ...
  var price_total = document.querySelector('.cart-modal__days-value').value * price_no_dot;
  document.querySelector('.cart-modal__product-new-price').innerHTML = '<p class="cart-modal__product-new-price">Your current cart value is: <span>$<%= price_total.toLocaleString("en-US").replace(",", ".") %></span></p>';
}

/***/ })

/******/ });
//# sourceMappingURL=cart-index-094b6b45bd0289c124da.js.map