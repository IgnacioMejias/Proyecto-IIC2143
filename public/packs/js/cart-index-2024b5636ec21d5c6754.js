...
var buttons = document.querySelectorAll('.cart-modal__form-days');
var days = document.querySelectorAll('.cart-modal__form-days-value').value;
sendAll.addEventListener('click', function () {
  console.log('clicado');

  for (var i = 0; i < buttons.length; i++) {
    buttons[i].value = days;
  }
});
...
/******/ });
//# sourceMappingURL=cart-index-2024b5636ec21d5c6754.js.map