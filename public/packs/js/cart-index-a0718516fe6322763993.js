...
sendAll.addEventListener('click', function () {
  for (var i = 0; i < day_forms.length; i++) {
    ...
    send_buttons[i].submit();
  }
});
send_buttons[0].addEventListener('click', function () {
  console.log('0 clicado');
});
send_buttons[1].addEventListener('click', function () {
  console.log('1 clicado');
});

/***/ })

/******/ });
//# sourceMappingURL=cart-index-a0718516fe6322763993.js.map