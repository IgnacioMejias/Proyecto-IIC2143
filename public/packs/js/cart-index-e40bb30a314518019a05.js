...
function change_price() {
  var price = document.querySelector('.cart-modal__product-new-price span').innerText;
  var regex = /\./g;
  ...
  document.querySelector('.cart-modal__product-new-price').innerHTML = 'Your current cart value is: $' + price_total.toLocaleString('en-US').replace(",", ".");
}

/***/ })

/******/ });
//# sourceMappingURL=cart-index-e40bb30a314518019a05.js.map