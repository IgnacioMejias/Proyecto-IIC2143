...
sendAll.addEventListener('click', function () {
  ...
  for (var i = 0; i < day_forms.length; i++) {
    var _setValues = function _setValues(index) {
      day_forms[index].value = days.value;
      date_forms[index].value = date.value;
...
/******/ });
//# sourceMappingURL=cart-index-f3e025535b9b342ad1f2.js.map